...
export default function piCompuse(pi: ExtensionAPI) {
	...
	pi.registerTool({
		name: "gui_click",
		label: "GUI Click",
		description: "Click a visually grounded GUI target. Name the control in `target`, e.g. 'button labeled \"Save\"'.",
		promptSnippet: "Click a GUI element identified by visual description",
		parameters: Type.Object({
			app: AppField,
	...
	pi.registerTool({
		...
		description: "Right-click a GUI target to open a context menu.",
