...
func leftDown(at point: CGPoint, clickState: Int64 = 1) throws {
	let e = try makeMouseEvent(.leftMouseDown, point: point); e.setIntegerValueField(.mouseEventClickState, value: clickState); post(e)
}
func leftUp(at point: CGPoint, clickState: Int64 = 1) throws {
	let e = try makeMouseEvent(.leftMouseUp, point: point); e.setIntegerValueField(.mouseEventClickState, value: clickState); post(e)
}
func rightDown(at point: CGPoint, clickState: Int64 = 1) throws {
	let e = try makeMouseEvent(.rightMouseDown, point: point, button: .right); e.setIntegerValueField(.mouseEventClickState, value: clickState); post(e)
}
func rightUp(at point: CGPoint, clickState: Int64 = 1) throws {
	let e = try makeMouseEvent(.rightMouseUp, point: point, button: .right); e.setIntegerValueField(.mouseEventClickState, value: clickState); post(e)
}
...
func handleEvent() throws {
	...
	case "scroll":
		if let x = optionalDouble("UNDERSTUDY_GUI_X"), let y = optionalDouble("UNDERSTUDY_GUI_Y") { try moveCursor(to: CGPoint(x: x, y: y)) }
